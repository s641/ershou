                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-header">
                            ...
                            <button class="layui-btn" onclick="xadmin.open('添加用户','./admin_add.php',600,400)"><i class="layui-icon"></i>添加</button>
                        </div>
                        <div class="layui-card-body ">
                            <table class="layui-table layui-form">
                              ...
                              <tbody>
								  <?php                                        //记录数据库中数据的条数
								     ...
								     $pre=$p-1;
								     $next=$p+1;
								     $sql2="select * from b_admin limit $star,$num";
                                ...
                                <tr>
                                  ...
                                  <td><?php echo $info['aid']?></td>
                                  <td><?php echo $info['teacher']?></td>
                                  <td><?php echo $info['password']?></td>
                                  <td><?php echo $info['addtime']?></td>
								  <td><?php echo $info['status']?></td>
                                  <td class="td-manage">
                                    <a title="编辑"  href="admin_edit.php?aid=<?php echo $info['aid']?>">
                                      <i class="layui-icon">&#xe642;</i>
                                    </a>
                                    <a title="删除" onclick="member_del(this,<?php echo $info['aid']?>)" href="javascript:;">
                                      <i class="layui-icon">&#xe640;</i>
                                    </a>
                                  </td>
                                </tr>
      ...
      function member_stop(obj,id){
		 ...
		 function member_del(obj,id){
			 layer.confirm('确认要删除吗？',function(index){
				 ...
				 oAjax.open('GET',"admin_del.php?id="+id,true);
				 oAjax.send();
