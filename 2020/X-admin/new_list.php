                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        <div class="layui-card-header">
							...
							<button class="layui-btn" onclick="xadmin.open('添加信息','./new_add.php',800,600)">
                            ...
                            <table class="layui-table layui-form">
                                ...
                                <tbody>
									<?php                                        //记录数据库中数据的条数
									   ...
									   $pre=$p-1;
									   $next=$p+1;
									   $sql2="select * from b_gonggao limit $star,$num";
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $info['ggid']?></td>
                                        <td><?php echo $info['title']?></td>
                                        <td><?php echo $info['content']?></td>
                                        <td><?php echo $info['time']?></td>
                                        <td class="td-manage">
                                            <a title="删除" onclick="member_del(this,<?php echo $info['ggid']?>)" href="javascript:;">
    ...
    <script>
        ...
        function member_del(obj,id){
			 layer.confirm('确认要删除吗？',function(index){
				 ...
				 oAjax.open('GET',"new_del.php?id="+id,true);
				 oAjax.send();
