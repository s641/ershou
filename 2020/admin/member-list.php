...
<html>
  ...
  <body class="layui-anim layui-anim-up">
    <div class="x-nav">
      ...
      <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right;margin-right:10px;" href="javascript:location.replace(location.href);" title="刷新">
    ...
    <div class="x-body" style="margin-right:20px;">
      ...
      <xblock>
        ...
        <button class="layui-btn" onclick="x_admin_show('添加用户','./member-add.php',600,400)"><i class="layui-icon"></i>添加</button>
        <span class="x-right" style="line-height:40px;margin-right:20px;">共有数据：
          <?php 
      ...
      while ($row=mysqli_fetch_assoc($result2)) {
        ...
        <tr>
            ...
            <td class="td-manage">
              ...
              <a title="删除" onclick="member_del(this,'<?php echo $id; ?>')" href="javascript:;">
                <i class="layui-icon">&#xe640;</i>
              </a>
            </td>
          </tr>;
