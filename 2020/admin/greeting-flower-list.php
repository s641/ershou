  ...
  <body class="layui-anim layui-anim-up">
    ...
    <div class="x-body">
      ...
      <xblock>
        ...
        <button class="layui-btn" onclick="x_admin_show('添加花束','greeting-add.php',600,400)"><i class="layui-icon"></i>添加</button>
        <span class="x-right" style="line-height:40px">共有数据：<?php 
            include_once('../inc/mysql.php');
            getconnection();
            $sql="select id from greeting_flowers";
        ...
        <tbody>
          <?php 
            ...
            $p=$_GET['p'];
              ...
              $pages=ceil($nums/$num);
              $start=($p-1)*$num;
              $sql2="select * from greeting_flowers limit $start,$num";
