  ...
  <body class="layui-anim layui-anim-up">
    ...
    <div class="x-body">
      ...
      <xblock>
        ...
        <button class="layui-btn" onclick="x_admin_show('添加花束','apology-add.php',600,400)"><i class="layui-icon"></i>添加</button>
        <span class="x-right" style="line-height:40px">共有数据：<?php 
            include_once('../inc/mysql.php');
            getconnection();
            $sql="select id from flowers_of_apology";
        ...
        <tbody>
          <?php 
            ...
            $p=$_GET['p'];
              ...
              $pages=ceil($nums/$num);
              $start=($p-1)*$num;
              $sql2="select * from flowers_of_apology limit $start,$num";
      ...
      while ($row=mysqli_fetch_assoc($result2)) {
        ...
        <tr>
            ...
            <td class="td-manage">
              ...
              <a title="编辑"  onclick="x_admin_show('编辑','apology-change.php?id=<?php echo $row['id'] ?>',600,400)" href="javascript:;">
                <i class="layui-icon">&#xe642;</i>
              </a>
      ...
      function member_del(obj,id){
          layer.confirm('确认要删除吗？',function(index){
            ...
            if(window.XMLHttpRequest){
              ...
              oAjax.open('GET',"apology_del.php?nid="+nid,true);
              oAjax.send();
