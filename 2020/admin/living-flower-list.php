  ...
  <body class="layui-anim layui-anim-up">
    ...
    <div class="x-body">
      ...
      <xblock>
        ...
        <button class="layui-btn" onclick="x_admin_show('添加花束','living-add.php',600,400)"><i class="layui-icon"></i>添加</button>
        <span class="x-right" style="line-height:40px">共有数据：<?php 
            include_once('../inc/mysql.php');
            getconnection();
            $sql="select id from living_flowers";
        ...
        <tbody>
          <?php 
            ...
            $p=$_GET['p'];
              ...
              $sql="select id from imported_flowers";
              $result=mysqli_query($dataconnection,$sql); 
              $nums=mysqli_num_rows($result);
              $num=6;
              $pages=ceil($nums/$num);
              $start=($p-1)*$num;
              $sql2="select * from living_flowers limit $start,$num";
