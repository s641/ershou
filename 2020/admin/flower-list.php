  ...
  <body class="layui-anim layui-anim-up">
    ...
    <div class="x-body">
      ...
      <xblock>
        ...
        <button class="layui-btn" onclick="x_admin_show('添加花束','flower-add.php',600,400)"><i class="layui-icon"></i>添加</button>
        ...
        <tbody>
          <?php 
            ...
            $p=$_GET['p'];
              ...
              $pages=ceil($nums/$num);
              $start=($p-1)*$num;
              $sql2="select * from birthday_flowers limit $start,$num";
      ...
      function member_del(obj,id){
          layer.confirm('确认要删除吗？',function(index){
            ...
            if(window.XMLHttpRequest){
              ...
              oAjax.open('GET',"flower_del.php?id="+id,true);
              oAjax.send();
